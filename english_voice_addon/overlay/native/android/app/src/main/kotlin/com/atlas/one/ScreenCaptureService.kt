...
class ScreenCaptureService : Service() {
    ...
    private fun makeNotification(): Notification {
        ...
        return builder
            ...
            .setContentTitle("Atlas Screen Vision is active")
            .setContentText("Your screen is shared only with your permission.")
            .addAction(android.R.drawable.ic_media_pause, "Stop Screen Vision", stopIntent)
            .setOngoing(true)
            .build()
    }
}
